...
public class OFMatch implements Cloneable, Serializable {
     ...
     * Set dl_type
     * 
     * Note: this must be set in a match before you can match with any
     * transport-layer fields! Otherwise it fails silently to match the 
     * transport-layer fields. -rjellinek
     * 
     * @param dataLayerType
     */
